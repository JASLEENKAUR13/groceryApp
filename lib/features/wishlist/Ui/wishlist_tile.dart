...
class Wishlistproduct_widget extends StatelessWidget{

  final ProductDatamodel  datamodel ;
   final WishlistBlocBloc wishlistbloc ;

  const Wishlistproduct_widget({required this.datamodel, required this.wishlistbloc});
          ...
          Text(datamodel.descrpition)],
            ...
            Row( 
              ...
              IconButton(onPressed: (){
                wishlistbloc.add(removefromwishlistEvent( wishlistitem: datamodel) );
                
              }, icon: Icon(Icons.favorite , color : Colors.pink)),
              IconButton(onPressed: (){
               wishlistbloc.add(addIntoCartEvent(wishlistitem: datamodel));
